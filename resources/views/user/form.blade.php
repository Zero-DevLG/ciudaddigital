<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="usertype" class="form-label">{{ __('Usertype') }}</label>
            <input type="text" name="usertype" class="form-control @error('usertype') is-invalid @enderror" value="{{ old('usertype', $user?->usertype) }}" id="usertype" placeholder="Usertype">
